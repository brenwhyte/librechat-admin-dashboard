...
import EstimatedCostText from "@/components/dashboard/estimated-cost-text";
			...
			>
				...
				>
					...
					>
						...
						{/* Row 2: Input Token, Output Token, MCP Calls, Web Search, Files, Estimated Cost */}
						<Box
							sx={{
								display: "grid",
						...
						>
							...
							>
								...
								<a
									...
									rel="noopener noreferrer"
								>
									CompanyGPT - Managed AI for Enterprises GDPR & AI-Act
									compliant.
								</a>
							</Typography>
						</Box>
